export const questions = [
  {
    questionText: "Qual a capital de Portugal?",
    answerOptions: [
      { answerText: "Lisboa", isCorrect: true },
  ...
  {
    questionText: "Qual a cor do céu em um dia claro?",
    answerOptions: [
  ...
  },
  {
    ...
    answerOptions: [
      { answerText: "Triangular", isCorrect: false },
      { answerText: "Quadrada", isCorrect: false },
      { answerText: "Redonda", isCorrect: true },
    ],
  },
];
